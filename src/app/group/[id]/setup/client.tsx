...
export function GroupSetupClient({ id, isGuest }: { id: string; isGuest: boolean }) {
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {/* Search existing users — hidden for guests */}
            {!isGuest && (
              <>
            ...
            <div className="space-y-2">
              <Label className="text-xs text-muted-foreground">
                {isGuest ? "Add members" : "Add someone without a Rekn account"}
              </Label>
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder={isGuest ? "Name" : "Guest name"}
                />
      ...
      {!isGuest ? (
        ...
        <p className="text-xs text-muted-foreground text-center">
          <a href="/phone" className="text-primary hover:underline font-medium">Sign up</a> to invite friends and link with real users.
        </p>
      )}
    </div>
  );
